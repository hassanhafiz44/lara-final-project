		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a href="{{ route('admin.feedback.index') }}" data-toggle="tooltip" data-placement="bottom" title="{{ is_unread_message() ? "You have unread messages" : "Customer feedback"}}" class="nav-link {{ is_unread_message() ? 'text-danger' : ''}}"><i class="fa fa-envelope"></i></a>
					</li>
					<li class="nav-item dropdown">
