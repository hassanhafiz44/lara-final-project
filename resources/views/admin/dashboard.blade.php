@extends('dashboardlayout')
	...
	<div class="bg-light">
		<div class="row py-3">
			<div class="col-md-4">
				<a href="#" class="btn btn-primary d-block" data-toggle="modal" data-target="#newuser"><i class="fa fa-plus"></i>Add new user</a>
			</div>
			<div class="col-md-4">
				<a href="#" class="btn btn-success d-block" data-toggle="modal" data-target="#deletuser"><i class="fa fa-plus"></i>Delet user</a>
			</div>
			<div class="col-md-4">
				<a href="#" class="btn btn-secondary d-block"><i class="fa fa-plus"></i>Add product</a>
			</div>
		</div>
	</div>
				...
				<div class="card mt-3">
					<div class="bg-primary text-white p-4">
						...
						<h2 class="float-right font-weight-bold" style="font-size: 35px;text-align: center;">
							<span class="d-block">Anything</span></h2>
					</div>
					<div class="card-footer text-primary">
